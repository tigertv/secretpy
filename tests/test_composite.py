...
class TestCompositeMachine(TestCase):
	...
	def test_main(self, Atbash, Caesar):
		...
		cipher2.encrypt.assert_called_with("CAESAR_ENCRYPTED", "", u"abcdefghijklmnopqrstuvwxyz")
		cipher2.decrypt.assert_called_with("CAESAR_DECRYPTED", "", u"abcdefghijklmnopqrstuvwxyz")
